...
(function($) {
    skel.init({
        ...
        breakpoints: {
            global: {
                range: '*',
                href: '{{ site.baseurl }}/assets/css/style.css?v=001',
                containers: 1400,
                grid: {
                    gutters: 50
                }
            ...
            wide: {
                range: '-1680',
                href: '{{ site.baseurl }}/assets/css/style-wide.css?v=001',
                containers: 1200,
                grid: {
                    gutters: 40
                }
            ...
            normal: {
                range: '-1280',
                href: '{{ site.baseurl }}/assets/css/style-normal.css?v=001',
                containers: 960,
                grid: {
                    gutters: 30
                },
            ...
            narrow: {
                range: '-980',
                href: '{{ site.baseurl }}/assets/css/style-narrow.css?v=001',
                containers: '95%',
                grid: {
                    gutters: 20
                }
            ...
            narrower: {
                range: '-840',
                href: '{{ site.baseurl }}/assets/css/style-narrower.css?v=001',
                grid: {
                    collapse: 1
                }
            },
            mobile: {
                range: '-736',
                href: '{{ site.baseurl }}/assets/css/style-mobile.css?v=001',
                containers: '90%',
                grid: {
                    gutters: 15
                }
            ...
            mobilep: {
                range: '-480',
                href: '{{ site.baseurl }}/assets/css/style-mobilep.css?v=001',
                grid: {
                    collapse: 2
                },
                containers: '100%'
